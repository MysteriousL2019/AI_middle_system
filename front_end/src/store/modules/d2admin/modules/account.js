  ...
  actions: {
    ...
    logout ({ commit, dispatch }, { confirm = false } = {}) {
      ...
      if (confirm) {
        ...
        MessageBox.confirm('Are you sure you want to log out the current user?', 'Logout users', { type: 'warning' })
          .then(() => {
          ...
          .catch(() => {
            commit('d2admin/gray/set', false, { root: true })
            Message({ message: 'Cancel cancellation operation' })
          })
      } else {
        logout()
      }
